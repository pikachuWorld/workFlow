        ...
        <div>
            <el-row>
                <div class="demo-input-suffix">
                    商品名称：
                    <el-input placeholder="请输入内容" v-model="params.productName" clearable>
                    </el-input>
                </div>
                <div class="demo-input-suffix">
                    收货人：
                    <el-input placeholder="请输入内容" v-model="params.consignee" clearable>
                    </el-input>
                </div>
                <div class="demo-input-suffix">
                    支付时间：
                    <el-date-picker v-model="payTime" type="datetimerange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                    </el-date-picker>
                </div>
            </el-row>
            <el-row>
                <div class="demo-input-suffix">
                    用户名称：
                    <el-input placeholder="请输入内容" v-model="params.userName" clearable>
                    </el-input>
                </div>
                <div class="demo-input-suffix">
                    手机号：
                ...
                <div class="demo-input-suffix">
                    发货时间：
                    <el-date-picker v-model="params.sentTime" type="datetimerange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                    </el-date-picker>
                </div>
            </el-row>
            <el-row>
                ...
                <el-button type="primary" @click="exportDispatchGoods">下载批量</el-button>
            </el-row>
        </div>
        <div class="order-table">
            <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                <el-tab-pane label="用户管理" name="first">
                    <el-table ref="multipleTable" :data="orderList" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="buyer" label="买家信息" width="100" show-overflow-tooltip>
                        </el-table-column>
