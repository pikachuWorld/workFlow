 ...
 * @Version: 1.0
 * @Author: jinqingsong
 * @Date: 2022-11-26 20:34:47
 * @LastEditors: jinqingsong
 * @LastEditTime: 2022-11-26 20:51:05
 */
...
class ThreeJs {
    ...
    setRenderer(): void {
        ...
        //这里 其实就是canvas 画布  renderer.domElement   document.getElementById('myThree')
        // document.body.appendChild(this.renderer.domElement);
        document.getElementById('demoThree')?.appendChild(this.renderer.domElement);
